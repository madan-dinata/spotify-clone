        ...
        <div className="card-body">
          <div className="flex flex-col items-center justify-center h-96">
            ...
            <div className="card-actions justify-center">
              <button
                className="bg-[#0c0c0c] text-[#65d46e] border border-green-400 font-semibold py-4 px-12 rounded-full hover:bg-[#65d46e] hover:text-[#0c0c0c] hover:border-transparent"
                onClick={handleLogin}>
                Login by Spotify
              </button>
            </div>
